...
def __init__(self, href, title, front_img_alt, front_img_alt_ru, title_ru, front_img, first_img, descriptions,
             descriptions_ru):
...
def topic_obj_gen():
    ...
    for count in max_index:
        yield Topics(Topics.curi_tr_html_get_topic_href()[count], curi_tr_get_topic_title()[count],
